...
class UpcomingActivitiesViewModelFactory : ViewModelProvider.NewInstanceFactory()
{
    ...
    override fun <T : ViewModel> create(modelClass : Class<T>) : T
    {
        ...
        val userRepository : IUserRepository =
            UserRepository(firebaseAuth, UserApi.retrofitService)
        return UpcomingActivitiesViewModel(userRepository) as T
    }
}